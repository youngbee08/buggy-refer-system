...
const Withdraw = () => {
  ...
  return (
    <div className='flex flex-col gap-6 pb-[6rem]'>
      <div className="bg-pryClr flex flex-col w-[90%] lg:w-[95%] mx-auto mt-4 rounded-[10px] p-4">
        ...
        <div className="flex flex-col gap-2 items-start lg:items-center">
          <h2 className='text-2xl lg:text-4xl font-bold text-accClrYellow'>N5,000</h2>
          <button className='bg-secClrWhite text-secClrBlack rounded-[6px] px-7 py-2 text-base lg:text-xl font-semibold' onClick={()=>setToggleWithdraw(!toggleWithdraw)}>Withdraw</button>
        </div>
      </div>
      {
        toggleWithdraw ? (
          <>
            <div className={`grid lg:grid-cols-2 w-[90%] lg:w-[95%] mx-auto gap-3`}>
              ...
              <div className="flex flex-col gap-1 lg:gap-3">
                ...
                <input type="text" className='bg-[#d9d9d9] rounded-[7px] border-0 outline-0 px-5 py-2 text-base lg:text-xl font-semibold'/>
              </div>
            </div>
            <button className='bg-[#2b7b20] rounded-[6px] px-7 py-2 text-base lg:text-xl font-semibold lg:w-1/2 cursor-pointer mx-auto text-secClrWhite' onClick={()=> setWithdrawPopup(true)}>Confirm Withdrawal</button>
            {
