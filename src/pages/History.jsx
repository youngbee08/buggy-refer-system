      ...
      <div className="bg-pryClr p-2 flex flex-col gap-3 rounded-[7px] w-full mx-auto">
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <h3 className="text-[18px] lg:text-2xl font-bold">Withdraw</h3>
          </div>
          <div className="flex items-center gap-2 lg:gap-6">
            <p className="bg-[#2b7b20] text-white rounded w-[80px] text-center text-[14px] p-[.3rem]">
              Successful
            </p>
            <h3 className="text-[18px] font-medium">N5000</h3>
          </div>
        </div>
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <h3 className="text-[18px] lg:text-2xl font-bold">Earn</h3>
          </div>
          <div className="flex items-center gap-2 lg:gap-6">
            <p className="bg-[#2b7b20] text-white rounded w-[80px] text-center text-[14px] p-[.3rem]">
              Successful
            </p>
            <h3 className="text-[18px] font-medium">N2000</h3>
          </div>
        </div>
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
          ...
          <div className="flex items-center gap-2 lg:gap-6">
            ...
            <h3 className="text-[18px] font-medium">N3000</h3>
          </div>
        </div>
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
        ...
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:gap-6">
            ...
            <h3 className="text-[18px] font-medium">N12000</h3>
          </div>
        </div>
        <div className="bg-secClrWhite rounded-[6px] p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
